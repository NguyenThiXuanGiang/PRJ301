                ...
                <div class="row g-3">
                    <div class="col-6">
                        ...
                        <input name="image" 
                               readonly
                               hidden
                               id="imageInput" value="${pro.getImage()}" type="text" class="w-100 p-2"/>
                        <div class="position-relative">
                            <img id="previewImage" src="${pro.getImage()}" alt="alt" style="max-width: 200px; max-height: 200px;"/>
                            <input class="w-100 p-2" 
                                   ...
                                   type="file" class="position-absolute top-0"/>
                        </div>
                    </div>
                    <div class="col-6">
                        ...
                        <input name="product_id" 
                               readonly
                               class="w-100 p-2" value="${pro.getProduct_id()}" required/>
                    </div>
                    <div class="col-6">
                        <label class="fw-bold fs-5">Name: </label>
                        <input name="name" value="${pro.getName()}" class="w-100 p-2"/>
                    </div>
                    <div class="col-6">
                        <label class="fw-bold fs-5">Quantity </label>
                        <input name="quantity"
                                value="${pro.getQuantity()}" 
                    ...
                    <div class="col-6">
                        ...
                        <input name="describe" require
                               value="${pro.getDescribe()}" 
                               class="w-100 p-2"/>
                    </div>
                    <div class="col-6">
                        <label class="fw-bold fs-5">Categories: </label>
                        <c:set var="cid" value="${pro.getCategory().getCategory_id()}" />
...
function displayImage(input) {
    ...
    if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
            ...
            document.getElementById('imageInput').value = input.value.split('\\').pop(); // Lấy tên file sau khi chọn
        };
