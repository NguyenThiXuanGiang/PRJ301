...
public class MainController extends HttpServlet {
    ...
    public UserDTO getUser(String username) {
        if ("admin".equals(username)) {
            return new UserDTO("admin", "Administrator", "123456", "admin");
        }
    ...
    // Nếu mật khẩu trong database được lưu dưới dạng hash, bạn cần so sánh hash thay vì trực tiếp so sánh chuỗi.
